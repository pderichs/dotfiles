;;; pd-adwaita-theme.el --- Tango-based custom theme for faces  -*- lexical-binding:t -*-

;; Copyright (C) 2010-2023 Free Software Foundation, Inc.

;; Author: William Stevenson <yhvh2000@gmail.com>
;; Modified by: Patrick Derichs <derichs@posteo.de>
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   ...
   ;; modify hl-line color
   `(hl-line ((,class (:foreground unspecified :background "#DDDDDD"))))
